package com.capture.grace.result;
...
public enum ResponseStatusEnum {
    ...
    EMAIL_NEED_WAIT_ERROR(505,false,"邮件发送太快啦~请稍后再试！"),
    EMAIL_CODE_ERROR(506,false,"验证码过期或不匹配，请稍后再试！"),
    ...
    USER_ID_EXIST_ERROR(516,false,"用户ID出现错误！"),
